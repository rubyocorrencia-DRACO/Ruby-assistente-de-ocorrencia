...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/github/download/index", (req, res) => {
    res.download(path.join(process.cwd(), "index-github.ts"), "index.ts");
  });
  ...
  app.get("/api/github/download/ruby-ai", (req, res) => {
    res.download(path.join(process.cwd(), "ruby-ai-github.ts"), "ruby-ai.ts");
  });
  ...
  app.get("/api/github/download/estrutura-final", (req, res) => {
    res.download(path.join(process.cwd(), "ESTRUTURA_GITHUB_FINAL.md"), "ESTRUTURA_GITHUB_FINAL.md");
  });

  app.get("/api/github/download/package-json", (req, res) => {
    res.download(path.join(process.cwd(), "package-github.json"), "package.json");
  });
